...
export const blogs = [
	...
	{
		id: 2,
		title: "Building Interactive CLI Package with React: A Practical Tutorial",
		date: "July 23, 2023",
		time: "6 min read",
		brief: "In this tutorial, we will embark on an exciting journey to explore how we can utilize React, the popular JavaScript library known for building user interfaces, to craft our very own interactive CLI commands. By the end of this tutorial, you will have a practical understanding of how to build a modern CLI...",
		image: "https://cdn.hashnode.com/res/hashnode/image/stock/unsplash/xkBaqlcqeb4/upload/f6a58e6219690f3de55e5b060161cedf.jpeg?w=1600&h=840&fit=crop&crop=entropy&auto=compress,format&format=webp",
		link: "https://amankumar1.hashnode.dev/building-interactive-cli-package-with-react-a-practical-tutorial",
	},
]
